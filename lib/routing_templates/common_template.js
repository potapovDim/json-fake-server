...
/**
  ...
  * @returns {string}
*/
function common_template(method, {path, response = {ok: 'OK'}, status = 200, params_response, response_from_url, authorization, request_body_equal, replace_static}) {
  let internal_body_part = ''

  if(replace_static) {
    internal_body_part += build_request_replace_static(replace_static)
  }
