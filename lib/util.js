...
const formResult = (action) => {
  ...
  const uselessProps = [
    'path', 'response', 'url', 'queryAndBodyResponse',
    'requestBody', 'errorResponse', 'realPath',
    'parsedPath', 'errorStatus', 'successStatus',
    'requestQuery', 'assertQueryAndBody', 'assertRequest'
  ];
