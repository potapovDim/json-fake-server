...
class FakeServer {
  ...
  put({ path, response, ...rest }) {
    this.serverAction = formActions('PUT', this.serverActions, path, response, ...rest);
  };
  post({ path, response, ...rest }) {
    this.serverAction = formActions('POST', this.serverActions, path, response, ...rest);
  };
  get({ path, response, ...rest }) {
    this.serverAction = formActions('GET', this.serverActions, path, response, ...rest);
  };
  del({ path, response, ...rest }) {
    this.serverAction = formActions('DELETE', this.serverActions, path, response, ...rest);
  };
  start() {
    this.runned = true;
