...
class FakeServer {
  ...
  get(path, response) {
    this
      .serverAction
      .push({called: false, callCount: 0, method: 'GET', path, response: assertResponse(response)})
  };
  del(path, response) {
    this
      .serverAction
      .push({called: false, callCount: 0, calledArgs: [], method: 'DELETE', response: assertResponse(response)})
  };
  start() {
